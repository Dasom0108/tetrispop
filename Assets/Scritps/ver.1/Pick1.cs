...
public class Pick1 : MonoBehaviour
{
    ...
    {
        if (collision.name == "citizenOff" && Input.GetKey("/"))
        {
           P1chara = (int)Chara.City;
           Debug.Log(P1chara);
            gameManager.P2chara = P1chara;
            gameManager.isP2ready = true;
        ...
        else if (collision.name == "DDDOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "KirbyOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "MarioOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "PikachuOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "DittoOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "IsabellaOff" && Input.GetKey("/"))
        {
        ...
        else if (collision.name == "KuppaOff" && Input.GetKey("/"))
        {
