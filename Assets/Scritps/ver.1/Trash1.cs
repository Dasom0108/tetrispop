...
public class Trash1: MonoBehaviour
{
    ...
    void Start()
    {
        stage = GameObject.Find("2p Stage").GetComponent<Stage2>();
    ...
    void Attack()
    {
        ...
        trashNode1.position = new Vector2(stage.offset_x + stage.offset2p, stage.halfHeight + stage.offset_y);
    ...
    bool CanMoveTo(Transform root)  //tetrominoNode를 매개변수 root로 가져오기
    {
        ...
        for (int i = 0; i < root.childCount; ++i)
        {
            ...
            int x = Mathf.RoundToInt(node.transform.position.x + stage.halfWidth) - stage.offset2p;
